    ...
    public class NavigationController : ApiController
    {
        ...
        public void getAllPairs()
        {
            for (int i = 0; i < nav.getAddresses().Count(); i++)
            {
                ...
                String urlString = "https://maps.googleapis.com/maps/api/directions/json?origin=" + nav.getStartAdd() + "&destination=" + nav.getAddresses().ElementAt(i) + "&region=il";
                ...
                if (i != nav.getAddresses().Count() - 1)
                {
                    ...
                    {
                        urlString = "https://maps.googleapis.com/maps/api/directions/json?origin=" + nav.getAddresses().ElementAt(i) + "&destination=" + nav.getAddresses().ElementAt(j) + "&region=il";
                ...
                urlString = "https://maps.googleapis.com/maps/api/directions/json?origin=" + nav.getAddresses().ElementAt(i) + "&destination=" + nav.getEndAdd() + "&region=il";
